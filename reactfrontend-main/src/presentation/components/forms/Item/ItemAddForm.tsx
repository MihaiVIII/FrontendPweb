            ...
            <div>
                <Grid container item direction="row" xs={12} columnSpacing={4}>
                    ...
                    <Grid container item direction="column" xs={6} md={6}>
                        <FormControl
                            fullWidth
                            error={!isUndefined(state.errors.userId)}
                        >
                            <FormLabel required>
                                <FormattedMessage id="globals.producer" />
                            </FormLabel>
                            <Select
                                {...actions.register("userId")}
                                value={actions.watch("userId")}
                            ...
                            >
                                ...
                                {
                                    state.producers?.data?.filter(x=>x.role == UserRoleEnum.Producer).map(x=>
                                        <MenuItem value={x.id}>
                                        <FormattedMessage id={String(x.name)} />
                                        </MenuItem>
                                    )
                                }
                            </Select>
                            <FormHelperText
                                hidden={isUndefined(state.errors.userId)}
                            >
                                {state.errors.userId?.message}
                            </FormHelperText>
                        </FormControl>
                    </Grid>
                </Grid>
