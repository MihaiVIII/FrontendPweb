...
import { useItemUpdateFormController } from "./ItemUpdateForm.controller";
 ...
 */
export const ItemUpdateForm = (props: { onSubmit?: () => void,pid:String,uid:String }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useItemUpdateFormController(props.pid,props.uid,props.onSubmit); // Use the controller.
