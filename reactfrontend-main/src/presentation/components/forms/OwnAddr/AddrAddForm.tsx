...
import { useAddrmAddFormController } from "./AddrAddForm.controller";
 ...
 */
export const AddrAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useAddrmAddFormController(props.onSubmit); // Use the address form controller
