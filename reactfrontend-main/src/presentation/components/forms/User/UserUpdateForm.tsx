 ...
 */
export const UserUpdateForm = (props: { onSubmit?: () => void,uid:String}) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useUserUpdateFormController(props.uid,props.onSubmit); // Use the controller.
