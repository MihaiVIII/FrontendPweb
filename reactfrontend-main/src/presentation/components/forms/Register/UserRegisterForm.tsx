...
import { useUserRegisterFormController } from "./UserRegisterForm.controller";
...
export const UserAddForm = (props: { onSubmit?: () => void }) => {
    ...
    const { state, actions, computed } = useUserRegisterFormController(props.onSubmit); // Use the controller.
            ...
            <ContentCard title={formatMessage({ id: "globals.signup" })}>
                <Grid container item direction="row" xs={12} columnSpacing={4}>
                    ...
                    <Grid container item direction="column" xs={6} md={6}>
                        ...
                        >
                            <FormLabel required>
                                <FormattedMessage id="globals.password2" />
                            </FormLabel>
                            <OutlinedInput
                                type="password"
                                {...actions.register("password2")}
                                placeholder={formatMessage(
                                    { id: "globals.placeholders.textInput" },
                                    {
                                        fieldName: formatMessage({
                                            id: "globals.password2",
                                        }),
                                    })}
                                autoComplete="none"
                            />
                            <FormHelperText
                                hidden={isUndefined(state.errors.password2)}
                            >
                                {state.errors.password2?.message}
                            </FormHelperText>
                        </FormControl>
                    </Grid>
                    <Grid container item direction="column" xs={6} md={6}>
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuItem value={UserRoleEnum.Producer}>
                                    <FormattedMessage id="globals.producer" />
                                </MenuItem>
                            </Select>
                            <FormHelperText
