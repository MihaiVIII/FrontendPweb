        ...
        >
          ...
          <Grid container item direction="column" xs={1}>
                <Button color="inherit">
                  <Link style={{ color: 'white' }} to={AppRoute.Index}>
                    Home
                  </Link>
                </Button>
          </Grid>
          <Grid container item direction="column" xs={8}>
            ...
            {isProducer && <Grid // If the user is logged in and it is an admin they can have new menu items shown.
              container
              item
              direction="row"
              xs={12}
            ...
            >
              <Grid container item direction="column" xs={1}>
                <Button color="inherit">
                  <Link style={{ color: 'white' }} to={AppRoute.PrucerProducts}>
                    {formatMessage({ id: "globals.products" })}
                  </Link>
                </Button>
              </Grid>
            </Grid>}
            {isClient && <Grid // If the user is logged in and it is an admin they can have new menu items shown.
              container
              item
              direction="row"
              xs={12}
            ...
            >
              <Grid container item direction="column" xs={1}>
                <Button color="inherit">
                  <Link style={{ color: 'white' }} to={AppRoute.ProductsStore}>
                    {formatMessage({ id: "globals.products" })}
                  </Link>
                </Button>
              </Grid>
              <Grid container item direction="column" xs={1}>
                <Button color="inherit">
                  <Link style={{ color: 'white' }} to={AppRoute.Facturi}>
                    {formatMessage({ id: "globals.Facturi" })}
                  </Link>
                </Button>
              </Grid>
            </Grid>}
